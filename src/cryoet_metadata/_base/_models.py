...
class Affine(CoordinateTransformation):
    ...
    affine: Optional[NDArray[Shape["3 exact_card, 3 exact_card"], int]] = Field(
        default=None,
...
class PointSet2D(Annotation, CoordMetaMixin):
    ...
    origin2D: Optional[NDArray[Shape["1-* N, 2 xy"], float]] = Field(
        default=None,
...
class PointSet3D(Annotation, CoordMetaMixin):
    ...
    origin3D: Optional[NDArray[Shape["1-* N, 3 xyz"], float]] = Field(
        default=None,
...
class PointVectorSet2D(Annotation, CoordMetaMixin):
    ...
    vector2D: Optional[NDArray[Shape["1-* N, 2 xy"], float]] = Field(
        default=None,
...
class PointVectorSet3D(Annotation, CoordMetaMixin):
    ...
    vector3D: Optional[NDArray[Shape["1-* N, 3 xyz"], float]] = Field(
        default=None,
...
class PointMatrixSet2D(Annotation, CoordMetaMixin):
    ...
    matrix2D: Optional[NDArray[Shape["1-* N, 2 xy, 2 xy"], float]] = Field(
        default=None,
...
class PointMatrixSet3D(Annotation, CoordMetaMixin):
    ...
    matrix3D: Optional[NDArray[Shape["1-* N, 3 xyz, 3 xyz"], float]] = Field(
        default=None,
